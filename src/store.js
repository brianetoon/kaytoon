export default {
    projects: [
        {
            ...
            intro: [
                "I was hired by Bridgeport Consulting to create communications that express GLWA’s work to ensure quality water to southeast Michigan.", 
                "GLWA advocates environmentally-friendly waste disposal, and shares the plans underway to ensure clean water and sound water infrastructure for the region. Their target audience includes homeowners, businesses and community leaders.",
        ...
        },
        {
            ...
            intro: [
                "I worked with a web developer and the owner of Lake Electronics Group to create new branding for the company. Lake wanted an updated image, but had an existing brand identity that they did not want to completely break with.",
    ...
    about: {
        kay: {
            header: "Kay Toon",
            info: [
                "My skill is to use design tools to compose information into an end product that is clear, concise, and most of all - a pleasure to view.",
                "Groups I have worked with range from human services, the arts, and industry, to family businesses. I am always eager to learn about a new endeavor and to partner with clients to tell their story and help reach their goals."
            ]
        },
        website: {
